...
const messages = {
  zh: {
    pageTitle: 'Oriedraw · CP 重绘', pageDescription: '在浏览器中把 22.5° 系 CP 图片重绘为 Oriedita .cp 文件。',
    ...
    welcomeTitle: '欢迎使用 Oriedraw', welcomeBody: '项目仍在持续迭代。遇到识别问题、异常结果，或者有改进建议，欢迎在 GitHub Issues 提交反馈。图片只在当前浏览器中处理。', welcomeIssues: '前往 GitHub Issues', welcomeClose: '知道了', githubAria: '打开 Oriedraw GitHub 项目', languageAria: 'Switch to English',
  },
  en: {
    pageTitle: 'Oriedraw · CP Redraw', pageDescription: 'Redraw 22.5°-system CP images as Oriedita .cp files directly in your browser.',
    ...
    welcomeTitle: 'Welcome to Oriedraw', welcomeBody: 'Oriedraw is still evolving. If you run into recognition issues, unexpected output, or have suggestions, please open an issue on GitHub. Images are processed only in your browser.', welcomeIssues: 'Open GitHub Issues', welcomeClose: 'Got it', githubAria: 'Open the Oriedraw GitHub repository', languageAria: '切换到中文',
  },
};
...
const exactEnglish = new Map(Object.entries({
  '正在准备浏览器识别引擎…': 'Preparing the browser recognition engine…', '正在加载 Python 运行环境…': 'Loading the Python runtime…', '正在加载 NumPy 与 OpenCV…': 'Loading NumPy and OpenCV…', '正在装入 Oriedraw 重建算法…': 'Loading the Oriedraw redraw engine…', '浏览器识别引擎已就绪': 'Browser recognition engine ready', '正在重建…': 'Redrawing…',
