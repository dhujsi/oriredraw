...
const messages = {
  zh: {
    ...
    loadingInitial: '正在寻找合法射线、交点并反复执行 cAMV 复核…',
    loadingSlow: '复杂图可能需要数分钟甚至更久，请保持页面开启',
    resultTitle: '重绘结果',
    download: '下载 .cp',
    overlay: '叠加检查',
    clean: '纯重绘',
  ...
  en: {
    ...
    loadingInitial: 'Finding legal rays and intersections and repeatedly running cAMV checks…',
    loadingSlow: 'Complex patterns may take several minutes or longer; keep this page open',
